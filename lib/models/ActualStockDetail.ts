  ...
  additionalInfo: {
    ...
    niftyIndices: [{
      ...
      enum: [
        ...
        'NIFTY_SMALLCAP_50', 'NIFTY_SMALLCAP_100', 'NIFTY_SMALLCAP_250', 'NIFTY_MIDSMALLCAP_400',
